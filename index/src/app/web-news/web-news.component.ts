...
export class WebNewsComponent {
  ...
  subtitle = 'ニュース';
  news=[
  {id:1,img:'./assets/img/20240606_main.png', date:'2024.06.06',title:'「ホロライブ」初の本格エンタメ参考書、『ホロライブ学力診断　中学5教科』発売決定！',txt:'カバー株式会社（本社：港区、代表取締役社長：谷郷元昭）は、弊社が運営する「ホロライブプロダクション」傘下の女性VTuberグループ「ホロライブ」において、株式会社Gakken より、初のエンタメ参考書『ホロライブ学力診断　中学5教科』の発売が決定したことをお知らせいたします。 Gakkenとホロライブ初のコラボ書籍となる、エンタメ参考書『ホロライブ学力診断　中学5教科』の発売が「7月25日（木）」'},
